...
const CoursePage = () => {
    const {fetchNextPage, isFetchingNextPage, hasNextPage, error,isLoading } = useFetchCourses();
        ...
        <MainLayout>
            ...
            <ul>
                {courses.map((course, index) => {
                    ...
                    const courseContent = (
                        <Box>
                            <strong>{course.course_nm}</strong><br />
                            강사명: {course.lectr_nm}<br />
                            시간: {course.start_tm} - {course.equip_tm}<br />
